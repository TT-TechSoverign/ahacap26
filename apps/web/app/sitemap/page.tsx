...
export default async function SitemapPage() {
    ...
    const staticLinks = [
        ...
        { name: '└ LG 8,000 BTU Dual Inverter In-Stock', path: '/shop/lg-dual-inverter-8000-btu-oahu' },
        { name: '└ Oahu Window AC Warehouse & Delivery', path: '/shop/oahu-window-ac-warehouse' },
        { name: '└ Window AC Plug & Voltage Guide', path: '/shop/window-ac-plug-guide' },
        { name: 'Window AC Installation Oahu', path: '/window-ac-installation' },
        ...
        { name: 'Ductless Mini Split Installation Oahu', path: '/ductless-mini-split-installation-oahu' },
        { name: 'Instant Mini Split Sizing & Estimate', path: '/mini-split-estimate' },
        { name: 'Mini Split AC Deep Cleaning Oahu', path: '/ac-cleaning-oahu' },
        { name: 'Mini Split AC Repair & Diagnostics Oahu', path: '/ac-repair-oahu' },
        { name: 'Window AC Deep Teardown Cleaning', path: '/window_ac_maintenance' },
