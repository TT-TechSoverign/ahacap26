...
function EducationalBenefitsSection() {
    return (
        <section id="educational-benefits" className="relative py-12 overflow-hidden group">
            <div className="absolute inset-0 bg-[#0a0e14] rounded-[2rem] border border-white/5 shadow-[0_0_100px_rgba(0,0,0,0.5)] ring-1 ring-white/10 mx-4 md:mx-0"></div>
            <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-primary/50 to-transparent"></div>
            <div className="absolute -left-24 top-0 w-[500px] h-[500px] bg-primary/10 rounded-full blur-[100px] pointer-events-none opacity-40"></div>
            <div className="absolute -right-24 bottom-0 w-[500px] h-[500px] bg-cyan-400/5 rounded-full blur-[100px] pointer-events-none opacity-30"></div>

            <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 space-y-12">
                <div className="text-center space-y-6">
                    <div className="inline-flex items-center gap-3 px-4 py-1.5 bg-primary/10 border border-primary/20 rounded-full text-primary text-[9px] md:text-[10px] font-header font-black tracking-[0.4em] uppercase shadow-[0_0_20px_rgba(0,174,239,0.15)]">
                        <span className="relative flex h-1.5 w-1.5">
                            <span className="animate-ping absolute h-full w-full rounded-full bg-primary opacity-75"></span>
                            <span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-primary"></span>
                        </span>
                        <EditableText contentKey="shop.educational_benefits.badge" />
                    </div>

                    <h2 className="text-3xl md:text-5xl font-header font-black text-white uppercase leading-[0.85] tracking-tighter">
                        <EditableText contentKey="shop.educational_benefits.title" /><br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-cyan-400 neon-glow">
                            <EditableText contentKey="shop.educational_benefits.title_highlight" />
                        </span>
                    </h2>

                    <div className="max-w-2xl mx-auto space-y-4">
                        <h3 className="text-white/90 font-header font-bold uppercase tracking-[0.2em] text-xs md:text-sm">
                            <EditableText contentKey="shop.educational_benefits.subtitle" />
                        </h3>
                        <div className="text-slate-400 text-sm md:text-base leading-relaxed font-medium opacity-80 uppercase tracking-widest [word-spacing:0.1em]">
                            <BacklinkedText narrativeKey="educational_benefits" />
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[0, 1, 2, 3].map((i) => (
                        <div key={i} className="relative group/card bg-[#0f131a]/40 backdrop-blur-2xl border border-white/5 rounded-2xl p-8 hover:border-primary/40 transition-all duration-700 hover:-translate-y-1">
                            <div className="absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-transparent opacity-0 group-hover/card:opacity-100 transition-opacity rounded-2xl"></div>

                            <div className="relative z-10 space-y-4">
                                <div className="w-12 h-12 rounded-xl bg-primary/10 border border-primary/20 flex items-center justify-center group-hover/card:bg-primary/20 transition-colors">
                                    <span className="material-symbols-outlined text-primary text-3xl group-hover/card:scale-110 transition-transform">
                                        <EditableText contentKey={`shop.educational_benefits.grid.${i}.icon`} />
                                    </span>
                                </div>

                                <div className="space-y-3">
                                    <h4 className="text-white font-header font-black uppercase tracking-widest text-sm">
                                        <EditableText contentKey={`shop.educational_benefits.grid.${i}.title`} />
                                    </h4>
                                    <p className="text-slate-500 text-[10px] leading-relaxed uppercase tracking-widest font-medium group-hover/card:text-slate-400 transition-colors">
                                        <EditableText contentKey={`shop.educational_benefits.grid.${i}.description`} />
                                    </p>
                                </div>
                            </div>
                        </div>
