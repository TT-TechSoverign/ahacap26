...
export default function ContactPage() {
    ...
    return (
        <div className="bg-background-dark min-h-screen text-white selection:bg-primary selection:text-white pb-36 lg:pb-32">
            <main className="max-w-4xl mx-auto px-4 sm:px-6 pt-[85px] md:pt-[165px]">
