    ...
    return (
        <div className="relative z-25 w-full bg-slate-900/90 backdrop-blur-md border-y border-cyan-500/30 py-4 shadow-[0_10px_30px_rgba(0,174,239,0.15)]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                <div className="flex flex-wrap justify-center items-center gap-x-4 gap-y-3 md:gap-8 lg:gap-12">
                    ...
                    <a 
                        ...
                        className="group flex items-center gap-2 text-white hover:text-cyan-400 font-header font-bold text-sm md:text-base uppercase tracking-wider transition-colors min-h-[48px] px-4 py-2 rounded cursor-pointer"
                    >
