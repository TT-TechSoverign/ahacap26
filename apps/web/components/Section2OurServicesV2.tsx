...
export default function Section2OurServicesV2() {
    ...
    const services = [
        {
            ...
            cleanImage: '/assets/yelpphotos/yelp1.jpg', // Placeholder - will need to be verified
            link: '/contact'
        },
        {
            id: 'commercial',
    ...
    return (
        <section className="relative w-full bg-slate-900 overflow-hidden">
            ...
            {/* Central CTA Overlay (Optional - floating or positioned) */}
            {/* Keeping it clean for now per 2x2 grid request */}
        </section>
    );
}
