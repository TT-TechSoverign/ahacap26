...
class Product(Base):
    ...
    coverage_aham = Column(String, nullable=True) # Official factory AHAM rating (e.g. 'Up to 550 sq. ft.')
    coverage_oahu = Column(String, nullable=True) # Island Microclimate Calibration (e.g. '250–380 sq. ft.')
    sizing_notes = Column(String, nullable=True)  # CEO climate calibration explanation
    ...
    shipping_weight = Column(String, nullable=True)
    min_window_width = Column(String, nullable=True)
    max_window_width = Column(String, nullable=True)
    min_window_height = Column(String, nullable=True)
    chassis_type = Column(String, nullable=True)
    ceer_rating = Column(String, nullable=True)
    dry_air_flow_cfm = Column(String, nullable=True)
